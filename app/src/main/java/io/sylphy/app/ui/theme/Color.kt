...
fun playerChromeColors(mode: ThemeMode): PlayerChromeColors {
    return when (mode) {
        ThemeMode.MONOCHROME_DARK -> PlayerChromeColors(
            ...
            border1 = Color(0xFF1E1E1E),
            border2 = Color(0xFF282828),
            muted = Color(0xFF3E3E3E),
            muted2 = Color(0xFF5E5E5E),
            fg = Color(0xFFE0E0E0),
            fgDim = Color(0x66E0E0E0),
            accent = Color(0xFFE0E0E0),
            progress = Color(0xFFE0E0E0),
            volumeFill = Color(0x59E0E0E0),
            playBg = Color(0xFFE0E0E0),
            playFg = Color(0xFF080808),
            discOuter = Color(0xFF0C0C0C),
            discBorder = Color(0xFF1E1E1E),
            groove = Color(0x05FFFFFF),
            labelBg = Color(0xFF0E0E0E),
            labelBorder = Color(0xFF1E1E1E),
        )
        ThemeMode.MONOCHROME_LIGHT -> PlayerChromeColors(
            bg = Color(0xFFF0EDE8),
            surface1 = Color(0xFFE8E5E0),
            surface2 = Color(0xFFDEDAD4),
            border1 = Color(0xFFCDC9C2),
            border2 = Color(0xFFB8B3AC),
            muted = Color(0xFF9E9890),
            muted2 = Color(0xFF706C65),
            fg = Color(0xFF1A1816),
            fgDim = Color(0x661A1816),
            accent = Color(0xFF1A1816),
            progress = Color(0xFF1A1816),
            volumeFill = Color(0x591A1816),
            playBg = Color(0xFF1A1816),
            playFg = Color(0xFFF0EDE8),
            discOuter = Color(0xFFE2DFD9),
            discBorder = Color(0xFFCDC9C2),
            groove = Color(0x081A1816),
            labelBg = Color(0xFFECE9E3),
            labelBorder = Color(0xFFCDC9C2),
        )
        ThemeMode.NOTHING_OS -> PlayerChromeColors(
            bg = Color(0xFF000000),
            surface1 = Color(0xFF0D0D0D),
            surface2 = Color(0xFF1A1A1A),
            border1 = Color(0xFF222222),
            border2 = Color(0xFF2E2E2E),
            muted = Color(0xFF484848),
            muted2 = Color(0xFF686868),
            fg = Color(0xFFF0F0F0),
            fgDim = Color(0x73F0F0F0),
            accent = Color(0xFFFF3B3B),
            progress = Color(0xFFFF3B3B),
            volumeFill = Color(0x66F0F0F0),
            playBg = Color(0xFFF0F0F0),
            playFg = Color(0xFF000000),
            discOuter = Color(0xFF0D0D0D),
            discBorder = Color(0xFF222222),
            groove = Color(0x04FFFFFF),
            labelBg = Color(0xFF111111),
            labelBorder = Color(0xFF222222),
        )
    }
}
