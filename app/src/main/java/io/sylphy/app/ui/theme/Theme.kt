...
fun animateColorSchemeAsState(targetColorScheme: ColorScheme): ColorScheme {
    val animationSpec = tween<Color>(Duration.Normal)
 ...
 *
 * @param mode The theme mode to apply (Dark, Light, or Nothing OS).
 * @param content The composable content subtree to theme.
 */
@Composable
fun SylphyTheme(
    mode: ThemeMode = ThemeMode.MONOCHROME_DARK,
    content: @Composable () -> Unit
) {
    val colorScheme = animateColorSchemeAsState(getSylphyColorScheme(mode))
